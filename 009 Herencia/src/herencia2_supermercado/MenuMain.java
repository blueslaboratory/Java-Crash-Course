...
import herencia2_lector.Lector;
...
public class MenuMain {
	...
	public static void main(String[] args) {
		...
		do {
			opcion = menuAlmacen(sc);
			//opcion = Lector.menuAlmacen(sc);
			switch (opcion) {
			case 1:
				supermercado.add(Lector.crearAlimentacion(sc));
				break;
			case 2:
				supermercado.add(Lector.crearTextil(sc));
				break;
			case 3:
				supermercado.add(Lector.crearDrogueria(sc));
				break;
			case 4:
				break;

			default:
				System.out.println("Introduzca una opcion valida (1-4)");
				break;
			}
		}while(opcion!=4);
		...
		while(hayCliente(sc)){
			Carrito carro = Lector.meterEnCarrito(sc, supermercado);
		};
	...
	public static int menuAlmacen(Scanner sc) {
		...
		System.out.println();
		System.out.println("*******************************************");
		System.out.println("PROCESO DE CREACION DEL SUPERMERCADO\n");
	...
	public static boolean hayCliente(Scanner sc) {
		boolean flag = false;
		char respuesta;
		
		System.out.print("Hay algun cliente (s/n): ");
