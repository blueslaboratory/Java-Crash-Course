...
public class Alimentacion extends Producto{
	...
	//CONSTRUCTORES
	public Alimentacion() {}
	public Alimentacion(Producto p, LocalDate fechaCad) {
		super(p);
		this.fechaCad = fechaCad;
	}
	public Alimentacion(String nombre, String codigo, double precio, LocalDate fechaCad) {
	...
	public String toString() {
		...
		return s + "\tFecha Caducidad: " + fechaCad;
	}
}