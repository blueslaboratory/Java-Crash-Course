class EjemploGit {
	...
	public static void main(String[] args) {
		...
		System.out.println("Curso de Git de pildoras informaticas V11");
		System.out.println("29/04/2022");
		System.out.println("Ver Git & GitHub.docx");
		System.out.println("Entornos pdf actividad 41");
		String user = "blueslaboratory";
	}
