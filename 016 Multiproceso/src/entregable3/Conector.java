...
public class Conector {
	...
	public static void main(String[] args) throws IOException {
		...
		File TXTimpares = new File(ruta, "impares.txt");
		File TXTordenados = new File(ruta, "ordenados.txt");
		...
		try {
			...
			desordenados = aleatorios(directorio, TXTimpares);
		} catch (IOException e) {
		...
		try {
			...
			ordenados = ordenar(directorio, desordenados, TXTordenados);
			System.out.println(ordenados);
		} catch (IOException e) {
	...
	public static String aleatorios(File directorio, File TXTimpares) throws IOException {
		...
		pb.redirectInput(TXTimpares);
		pb.redirectOutput(TXTimpares);
	...
	public static String ordenar(File directorio, String numeros, File TXTordenados) throws IOException {
		...
		pb.redirectInput(TXTordenados);
		pb.redirectOutput(TXTordenados);
