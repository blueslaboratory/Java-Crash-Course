...
public class DemasiadoRapidoException extends Exception{
	...
	public DemasiadoRapidoException(String str) {
		super(str);
	}
	
	//THROWS
	public static void lanzar() throws DemasiadoRapidoException {
		throw new DemasiadoRapidoException("Se han superado los 100 km/h");
	}
	
	/*
	 * Para lanzar una excepcion lo mas comun es lanzarla y tratarla
	 * en el metodo del que sale
	 * 
	 */
}
