...
public class Camion extends Vehiculo{
	...
	public void quitaRemolque() {
		this.r = null;
		System.out.println("Se ha quitado el remolque");
	}
	@Override
	public void acelerar(double v) throws DemasiadoRapidoException {
		if(this.r!=null && v>100) {
			DemasiadoRapidoException.lanzar();
		}
		else {
			super.setV(v);
			System.out.println("El vehiculo ha acelarado: " +v +"km/h");
		}
	}
	...
	//GETTERS
	public Remolque getR() {
		return r;
	}
	
	//SETTERS
	public void setR(Remolque r) {
		this.r = r;
	}
