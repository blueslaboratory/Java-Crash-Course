...
//		escribirArray(array);	
	...
	public static void modificarGlobal2(){
		System.out.println("Valor de v dentro del metodo antes de mod: " + miGlobal);		
		miGlobal += 100;
		System.out.println("Valor de v dentro del metodo despues de mod: " + miGlobal);		
	}
...
//		for (int i=0; i < v.length;i++)
//			v[i] += 100;
//		System.out.println("Valor de v dentro del metodo despuess " + v);
//		
//		return v;
//	}
